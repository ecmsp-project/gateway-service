...
class JwtConfig {
    ...
    public FilterRegistrationBean<JwtAuthenticationFilter> jwtAuthenticationFilter(JwtTokenReader jwtTokenReader) {
        ...
        registrationBean.addUrlPatterns("/api/payment/*", "/api/orders/*", "/api/returns/*", "/api/cart/*", "/api/users/*", "/api/roles/*", "/api/deliveries/*", "/api/statistics/*", "/api/products/*", "/api/categories/*", "/api/variants/*", "/api/properties/*");
